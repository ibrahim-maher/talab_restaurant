    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="resttab-sec">
          ...
          <div class="form-group row">
            <label class="col-3 control-label">{{trans('lang.restaurant_cuisines')}} 1</label>
            <div class="col-9">
          ...
          <div class="form-group row">
            <label class="col-3 control-label">{{trans('lang.restaurant_cuisines')}} 2</label>
            <div class="col-9">
          ...
          <div class="form-group row">
            <label class="col-3 control-label">{{trans('lang.restaurant_cuisines')}} 3</label>
            <div class="col-9">
        ...
        await database.collection('vendor_categories').get().then( async function(snapshots){
          snapshots.docs.forEach((listval) => {
            ...
            if(data.id == restaurant.categoryID){
              $('#restaurant_cuisines1').append($("<option selected></option>")
                .attr("value", data.id)
                .text(data.title));
            }else{
            ...
            if(data.id == restaurant.categoryID2){
              $('#restaurant_cuisines2').append($("<option selected></option>")
                .attr("value", data.id)
                .text(data.title));
            }else{
            ...
            if(data.id == restaurant.categoryID3){
              $('#restaurant_cuisines3').append($("<option selected></option>")
                .attr("value", data.id)
                .text(data.title));
            }else{
